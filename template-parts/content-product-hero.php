...
?>
    <section id="hero" class="grid-row">
        ...
        <div class="hero-slider">
            <?php foreach ($heroSlides as $slides) { ?>
                <div>
                                    <?php echo wp_get_attachment_image($slides['slide_image']['id'], 'extraLarge', false, ["class" => "", "alt" => $slides['slide_image']['alt']]); ?>
<!--                    <img class=""-->
<!--                         src="--><?php //echo wp_get_attachment_image_url($slides['slide_image']['id'], 'extraLarge') ?><!--"-->
<!--                         srcset="--><?php //echo wp_get_attachment_image_srcset($slides['slide_image']['id'], 'extraLarge') ?><!-- 1920w,-->
<!--                                --><?php //echo wp_get_attachment_image_srcset($slides['slide_image']['id'], 'mediumLarge') ?><!-- 1536w,-->
<!--                                --><?php //echo wp_get_attachment_image_srcset($slides['slide_image']['id'], 'mediumLarge') ?><!-- 768w,-->
<!--                                --><?php //echo wp_get_attachment_image_srcset($slides['slide_image']['id'], 'medium') ?><!-- 576w,-->
<!--                                --><?php //echo wp_get_attachment_image_srcset($slides['slide_image']['id'], 'small') ?><!-- 384w,"-->
<!--                         sizes="100vw"-->
<!--                         alt="--><?php //echo $slides['slide_image']['alt']; ?><!--">-->
                </div>
            <?php } ?>
        </div>
    </section>
